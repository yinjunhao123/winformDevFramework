...
{
    public class PLC_BounceHandler : IPLC_BounceHandler
    {
        private readonly ILogger<PLC_BounceHandler> _logger;
        ...
        public PLC_BounceHandler(ILogger<PLC_BounceHandler> logger,
        ...
        private void GenerateCurveImage(List<double> dataList, string imagePath, string stationCode, string recipe, string partType, string barCode)
        {
            ...
            try
            {
                ...
                _logger.LogInformation($"曲线图片生成成功: {imagePath}");
            }
            catch (Exception ex)
            {
